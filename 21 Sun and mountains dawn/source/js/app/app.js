...
function ( THREE, camera, container, controls, geometry, material, noise, renderer, scene, Terrain ) {
  var app = {
    ...
    init: function () {
      ...
      //app.terrain = new Terrain( noise, 1024, 8, 64 );
      app.terrain = new Terrain( noise, 2048, 4, 64 );
      scene.add( app.terrain );

      // Add sky
      app.sky = new THREE.Mesh( geometry.sky, material.sky );
      app.sky.position.z = 200;
      app.sky.visible = true;
      scene.add( app.sky );
      
      /// Add sky2
      app.sky2 = new THREE.Mesh( geometry.skypano, material.atmosphere );
      app.sky2.position.z = 120000;
       app.sky2.position.y = -4000;     
      app.sky2.rotation.z = 2.9;
      scene.add( app.sky2 );
 ...
 //   },
    ...
    animate: function () {
      ...
      //Sun shader
      material.atmosphere.uniforms.iGlobalTime.value = time * 0.1;
/*
      // Look left right
