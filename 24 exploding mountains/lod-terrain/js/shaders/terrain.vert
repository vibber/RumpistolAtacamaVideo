...
void main() {
  ...
  //noise = 10.0 *  -.10 * turbulence( .5 * normal + time );
  float noise2 = 10.0 *  -.10 * turbulence( 50.0 * normal + noisetime);
  float b = 200.0 * pnoise( 0.01 * vPosition + vec3( 2.0 * noisetime), vec3( 100.0 ) );
  float displacement = - 10. * noise2 + b;
  
  vPosition = vPosition + normal * displacement;
