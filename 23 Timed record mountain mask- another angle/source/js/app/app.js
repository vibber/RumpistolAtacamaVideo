      ...
      if (app.mode == 'RECORD') {
        app.outputData.push(
        {
          ...
          if (app.camData[app.currentFrame]) {
              camera.position.set(app.camData[app.currentFrame+700].cam.pos.x, app.camData[app.currentFrame+700].cam.pos.y, app.camData[app.currentFrame+700].cam.pos.z);
              camera.rotation.set(app.camData[app.currentFrame+700].cam.rot.x, app.camData[app.currentFrame+700].cam.rot.y, app.camData[app.currentFrame+700].cam.rot.z);
          }
      }
